namespace Memento
{
	...
	public class EmployeeManagerRepository : IEmployeeManagerRepository
	{
		...
		/// <summary>
		/// For demo purposes, write out the data to the console window
		/// </summary>
	...
	public class AddEmployeeToManagerList : ICommand
	{
		...
		public bool CanExecute()
		{
			...
			// employee shouldn´t already exist on managers list
			...
			// one managers list at the same time etc.
			return true;
		}
	...
	public class CommandManager
	{
		...
		{
			// if the command has not yet been stored yet, store it - we will
